...
<div class="container container-home">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <ol class="carousel-indicators">
            ...
            <li data-target="#carouselExampleIndicators" data-slide-to="{{ $key }}" @if ($key==1) class="active" @endif>
            </li>
            @endforeach
        </ol>
        <!--Carousel Banner-->
        <div class="carousel-inner">
            ...
            <div class='carousel-item @if ($key == 1) active @endif'>
                <a href="{{ $sliders->link == '' ? '#' : $sliders->link }}" @if($sliders->link != '') target='_blank' @endif>
                ...
                <div class="row row-slick slick">
                    ...
                    <div class='col'>
                        <div class='card card-slick'>
                            <img class='card-img-top' src='/assets/foto/kursus/{{ $kursuss->foto_kursus }}' alt='Image'>
                    ...
                    <!--
                                    ...
                                    <div class='col'>
                                        <div class='card card-slick'>
                                            <img class='card-img-top' src='/assets/foto/kursus/kursus-20210314103700.jpg' alt='Image'>
                                            <div class='card-body d-flex flex-column'>
                                                <h5 class='subheader-heavy'>GEM 1 - Dasar Bisnis</h5>
                                                <a href='/course-detail&pl=28&k=3&p=5&pilid=1'
                                                    class='btn mt-auto btn-mulai-slick'>Mulai Kelas</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class='col'>
                                        <div class='card card-slick'>
                                            <img class='card-img-top' src='/assets/foto/kursus/kursus-20210314103631.jpg' alt='Image'>
                                            <div class='card-body d-flex flex-column'>
                                                <h5 class='subheader-heavy'>GEM 2 - Bisnis Berkembang</h5>
                                                <a href='/course-detail&pl=29&k=3&p=5&pilid=1'
                                                    class='btn mt-auto btn-mulai-slick'>Mulai Kelas</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class='col'>
                                        <div class='card card-slick'>
                                            <img class='card-img-top' src='/assets/foto/kursus/kursus-20210314103647.jpg' alt='Image'>
                                            <div class='card-body d-flex flex-column'>
                                                <h5 class='subheader-heavy'>GEM 3 - Visi Misi Bisnis</h5>
                                                <a href='/course-detail&pl=30&k=3&p=5&pilid=1'
                                                    class='btn mt-auto btn-mulai-slick'>Mulai Kelas</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class='col'>
                                        <div class='card card-slick'>
                                            <img class='card-img-top' src='/assets/foto/kursus/20210529042142.jpg' alt='Image'>
                                            <div class='card-body d-flex flex-column'>
                                                <h5 class='subheader-heavy'>testa</h5>
                                                <a href='/course-detail&pl=39&k=3&p=5&pilid=1'
                                                    class='btn mt-auto btn-mulai-slick'>Mulai Kelas</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class='col'>
                                        <div class='card card-slick'>
                                            <img class='card-img-top' src='/assets/foto/kursus/20210514055544.jpg' alt='Image'>
                                            <div class='card-body d-flex flex-column'>
                                                <h5 class='subheader-heavy'>tests</h5>
                                                <a href='/course-detail&pl=38&k=4&p=5&pilid=4'
                                                    class='btn mt-auto btn-mulai-slick'>Mulai Kelas</a>
                                            </div>
                                        </div>
                                    </div> -->
        ...
        <div class="col">
            <div class="card card-home-res premium">
                ...
                <div class="card-body">
                    ...
                    @else
                    <a href='#' class='btn btn-pri-normal btn-mulai-res' data-fancybox data-src='#pesanUpgrade'
                        href='javascript:;'>Mulai Kelas</a>
                    @endif
                </div>
            </div>
...
<div class="container container-home container-card-non-res">
    <div class="d-flex justify-content-between">
        ...
        <span class="body-heavy"><a id="lihatSemuaEvent" @if (Auth::user()) href="/event" @else href="#"
                class="btn subheader-heavy btn-login modal-trigger-login text-primary" @endif>Lihat Semua ></a></span>
    </div>
        ...
        <div class='col'>
            <div class='card card-home-event'>
                ...
                <div class='card-body d-flex flex-column'>
                    ...
                    @else
                    <a href='#' class='btn mt-auto btn-pri-normal btn-daftar-event modal-trigger-daftar'>Daftar</a>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class='col'>
            <div class='card card-home-res'>
                ...
                <div class='card-body'>
                    ...
                    <a href='#' class='btn btn-pri-normal btn-mulai-res' data-fancybox data-src='#pesanAwal'>Daftar</a>
                </div>
            </div>
        </div>
        @endforeach
