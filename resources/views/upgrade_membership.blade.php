    ...
    <center>
        ...
        <div class="container container-payment">
            <div class="desc-trans">
                <h2>Transaksi: Upgrade Membership ke-{{ $paket->nama_paket }}</h2>
            </div>
            ...
            <div class="container-card">
                <div class="card">
                    <div class="card-header">
                        <!-- date('d F Y H:iA') -->
                        BAYAR SEBELUM {{ \Carbon\Carbon::parse(date('d-m-Y H:i:s'))->addDays(2)->format('d F Y H:iA') }}
                    </div>
                    <div class="card-body">
                        <h5 class="card-title harga">Rp {{ number_format($paket->harga_member, 2, ',', '.') }}</h5>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/membership/upgrade/{{ $paket->id_paket }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="harga" value="{{ $paket->harga_member }}">
                            <input type="hidden" name="transaksi" value="Upgrade Membership ke-{{ $paket->nama_paket }}">
                            ...
                            <input type="file" name="foto" id="gambarAmbil" accept="image/*" required>
                            <br><br>
