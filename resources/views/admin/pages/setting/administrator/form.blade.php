...
@section('content')
    ...
    <form action="@if ($user) /admin/administrator/edit/{{ $user->id_user }} @else /admin/administrator/tambah @endif" method="post" enctype="multipart/form-data">
        @csrf
        <!-- Begin Page Content -->
                ...
                <div class="col-md-3">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            @if ($user)
                                <a href="/admin/administrator/delete/{{ $user->id_user }}"
